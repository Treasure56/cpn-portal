...
export default function TableRow({_id, email, center_id, fullname: full_name, phone, course_id, reg_date, student_id, plan, ...props }:StudentDetailed) {
  return (
    <tr className=" text-black-400 font-[400] text-sm text-neutral-text bg-light border-b first-of-type:bg-red-400">
      ...
      <td><div className="flex gap-2 justify-end">
        <EditModal students={{_id, email, plan, center_id, fullname: full_name, phone, course_id, reg_date, student_id, ...props }}><button className="btn-edit"><FaEdit /></button></EditModal>
