...
export default function TableRow({_id, email,  center, fullname: full_name, phone, plan, reg_date, student_id, ...props }:StudentDetailed) {
  return (
    <tr className=" text-black-400 font-[400] text-sm text-neutral-text bg-light border-b first-of-type:bg-red-400">
      <td className="py-1 flex gap-1 flex-col"><Link href={paths.adminSingleStudent(_id)}>{full_name}</Link>
       {email}
      </td>
