...
const schema = z.object ({
   ...
   staffId: validators.min3
})
type FormType = z.infer<typeof schema>


export async function deleteCertificate(_:ActionResponse, formData:FormData):Promise<ActionResponse>{
    ...
    try {
        const req = await ServerRequest.delete(apis.manager.deleteCert(data.staffId, data.certificateId), {})
