...
export async function adminchangepassword(_:ActionResponse, formData:FormData):Promise<ActionResponse>{
    let nextPath = ""
    ...
    try {
        const req = await ServerRequest.post(apis.admin.adminChangePassword,data)
